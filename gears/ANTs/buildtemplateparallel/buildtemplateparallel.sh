...
# Customized version of buildtemplateparallel.sh from v2.1.0 of ants 
# (https://github.com/ANTsX/ANTs/blob/v2.1.0/Scripts/buildtemplateparallel.sh)
# that turns off per-iteration backups in order to save space.
# See lines 1267-1272
